...
(async () => {
  ...
  // If the date is not proovided the bot will scrape all the sold items in the website
  const ebayPs5 = new Ebay('ps5', '1/1/2021');
  // const ebayPs5 = new Ebay('ps5');
  const ps5Results = await ebayPs5.results();

  console.log(ps5Results);

  const ebayXbox = new Ebay('xbox series x', '1/1/2021');
